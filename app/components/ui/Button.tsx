...
const buttonStyles = cva(
  "flex items-center rounded-md px-4 py-2 text-caption",
  {
    variants: {
      variant: {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: "info",
        intent: "ghost",
        className: "bg-indigo-100 text-indigo-500 border-none",
      },
      {
        variant: "info",
        intent: "link",
      ...
      },
      {
        variant: "warning",
        intent: "ghost",
        className: "bg-orange-100 text-orange-500 border-none",
      },
      {
        variant: "warning",
        intent: "link",
...
export const Button = ({
  ...
  return (
    <button
      className={twMerge(
        buttonStyles({ variant, intent, fullWidth, className })
      )}
      {...props}
    >
      {children}
